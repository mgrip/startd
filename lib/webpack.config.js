...
const configs = [{
  name: "server",
  ...baseConfig,
  entry: [_path.default.resolve((0, _dirname.default)(), process.env.NODE_ENV === "production" ? "runServer" : "server.js")],
  output: {
  ...
  name: "client",
  ...baseConfig,
  entry: [_path.default.resolve((0, _dirname.default)(), "client.js")],
  output: {
