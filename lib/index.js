...
class StartdServer extends _react.default.Component {
  ...
  async componentDidMount() {
    ...
    if (this.state.inputHeaderPath) {
      ...
      headerPath = _path.default.resolve(process.cwd(), // $FlowFixMe flow isn't picking up the check above
      ...
      if (!_fs.default.existsSync(headerPath)) {
    ...
    const startd = new _startd.default(appPath, useProxy, middlewarePath, headerPath);
...
(function () {
  ...
  reactHotLoader.register(inputHeaderPath, "inputHeaderPath", "/Users/mgrip/repos/startd/src/index.tsx");
