...
class Startd {
  constructor(appPath, useProxy, middlewarePath, headerPath) {
    _defineProperty(this, "webpackConfig", void 0);

    this.webpackConfig = this.getWebpackConfig(appPath, useProxy, middlewarePath, headerPath);
  }

  getWebpackConfig(appPath, useProxy, middlewarePath, headerPath) {
    return _webpackConfig.default.map(singleConfig => ({ ...singleConfig,
      plugins: [...singleConfig.plugins, new _webpack.default.DefinePlugin({ ...{
        ...
        ...(headerPath ? {
          HEADER_PATH: JSON.stringify(headerPath)
        } : {}),
