...
function Cli({
  ...
  return _react.default.createElement(_reactCliRenderer.Section, {
    ...
    key: index
  }, index > 0 ? _chalk.default.dim(`${index + 1}: ${log}`) : `${index + 1}: ${log}`))))), _react.default.createElement(_reactCliRenderer.Section, null, stdout.map((line, index) => _react.default.createElement(_reactCliRenderer.Section, {
    key: index
  }, line))));
}